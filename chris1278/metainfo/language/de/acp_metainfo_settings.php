...
$lang = array_merge($lang, [
	...
	'CMI_META_OPEN_GRAPH_ENABLE_EXPLAIN'				=> 'Hier können die Open Graph META Tags aktiviert werden.<br><br> Lese hier auch nachfolgende Dokumentation: <a target="_blank" href="https://www.seo-trainee.de/glossar/open-graph-meta-tags/">>>Dokumentation Open Graph META Tags<<</a>',
	'CMI_META_OG_URL'									=> 'Auswahl der URL Einstellung für Social-Media Tag',
	'CMI_META_OG_URL_EXPLAIN'							=> 'Hier kannst du auswählen ob du eine einzelne Bestimmte URL <b><u>Fixiert</u></b> haben möchtest <i><b>(Dann wird immer die URL zur Foren-Index benutzt)</b></i> die als Metatag in den Social-Media Tags angezeigt werden soll oder ob du das <b><u>Dynamisch</u></b> machen willst dann wird wenn du ein Thema verlinkst immer die direkte URL des Themas genommen.',
	...
	'CMI_META_OG_DESCRIPTION_EXPLAIN'					=> 'Hier kann eine kurze Beschreibung eingefügt werden, die dann für Soziale Medien genutzt werden kann. Ähnlich wie die Meta-Description für Suchmaschinen.<br><br>Weitere Informationen:<br><br><a href="https://de.ryte.com/magazine/open-graph-tags" target="_blank">>>Informationen bezüglich Open Graph META Tags-Description<<</a>',
	'OG_DESCRIPTION'									=> 'Hier die Description Beschreibung einfügen',
	'CMI_META_OG_LOCALE'								=> 'Seitensprache Open Graph Tag',
	'CMI_META_OG_LOCALE_EXPLAIN'						=> 'Hier kann die Seitensprache im Open Graph Tag angegeben werden. Bitte unbedingt die Korrekte Schreibweise beachten.<br>Die ersten beiden Buchstaben klein geschrieben und die anderen beiden Groß geschrieben. Und mit dem Unterstrich verbinden.<br><br> Beispiel: Für Deutschland <b>de_DE</b> oder für England <b>en_GB</b><br><br><a href="https://www.localeplanet.com/icu/" target="_blank"><b>>>>Hier eine Liste mit den Kennungen die man benutzen kann<<<</b></a> ',
	'OG_LOCALE'											=> 'de_DE',
	'FAVIC'												=> 'Favicons',
	'FA_APPID_ENABLE'									=> 'Nutzung der Facebook APP-ID nutzen',
	'FA_APPID_ENABLE_EXPLAIN'							=> 'Dies kannst du aktivieren wenn du eine Facebook APP-ID hast und diese angeben möchtest.<br><br><b class="acp-warn">Achtung: </b> Dies benutzen normalerweise nur App Entwickler die auch mit Facebook arbeiten.',
	'FA_APPID'											=> 'Facebook APP-ID',
	'FA_APPID_EXPLAIN'									=> 'Hier kannst du deine Facebook APP-ID eingeben.',
