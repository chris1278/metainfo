...
class metainfo_overview
{
	...
	public function main()
	{
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			$this->config->set('ov_fav_enable', $this->request->variable('ov_fav_enable', 0));
			$this->config->set('ov_google_site_verification_instruction', $this->request->variable('ov_google_site_verification_instruction', 0));
		...
		$this->template->assign_vars([
			...
			'OV_FAV_ENABLE'								=>	$this->config['ov_fav_enable'],
			'OV_GOOGLE_SITE_VERIFICATION_INSTRUCTION'	=>	$this->config['ov_google_site_verification_instruction'],
